...
from models import AgentCreate, AgentOut, EventOut, WorldOut, MeOut, ActionIn
...
async def owner(authorization: Optional[str]):
    return await wallet_auth.owner(authorization)
